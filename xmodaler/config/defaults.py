...
_C.DATALOADER.MODE = 'COCO'

_C.DATALOADER.TYPE = ['normal']

_C.DATALOADER.TRAIN_BATCH_SIZE = 64

_C.DATALOADER.TEST_BATCH_SIZE = 64

_C.DATALOADER.INPUT_SIZE = 0
...
_C.DATALOADER.ANNO_WEIGHT_TRAIN = ['']
...
_C.DATALOADER.SEQ_PER_SAMPLE_NET1 = 1

_C.DATALOADER.SEQ_PER_SAMPLE_NET2 = 1
...
_C.MODEL.MAX_SEQ_LEN_NET1 = 17

_C.MODEL.MAX_SEQ_LEN_NET2 = 17

_C.MODEL.COCO_MAX_SEQ_LEN = 17

_C.MODEL.CROWD_MAX_SEQ_LEN = 17
...
_C.MODEL.V_E.IN_DIM = 2048

_C.MODEL.V_E.OUT_DIM = 1024

_C.MODEL.V_E.G_IN_DIM = 512

_C.MODEL.V_E.ACTIVATION = 'none'

_C.MODEL.V_E.ELU_ALPHA = 0.5

_C.MODEL.V_E.USE_NORM = False

_C.MODEL.V_E.DROPOUT = 0.0

_C.MODEL.V_E.LOCATION_SIZE = 0
...
_C.MODEL.S_E.WORD_EMBEDDING_SIZE = 512

_C.MODEL.S_E.WORD_VEC_SIZE = 512

_C.MODEL.S_E.HIDDEN_SIZE = 512

_C.MODEL.S_E.BIDIRECTIONAL = False

_C.MODEL.S_E.WORD_DROP_OUT = 0.0

_C.MODEL.S_E.RNN_DROP_OUT = 0.0

_C.MODEL.S_E.RNN_NUM_LAYERS = 1

_C.MODEL.S_E.RNN_TYPE = 'lstm'

_C.MODEL.S_E.TOKEN_ACTIVATION = 'relu'

_C.MODEL.S_E.TOKEN_DROPOUT = 0.5
...
_C.MODEL.VL_M.HIDDEN_SIZE = 512

_C.MODEL.VL_M.NUM_INPUT_CHANNELS = 256

_C.MODEL.VL_M.NUM_OUTPUT_CHANNELS = 256

_C.MODEL.VL_M.NUM_FEATMAPS = 5
# ----------------------------------------------------------------------------
# Token embedding
# ----------------------------------------------------------------------------
