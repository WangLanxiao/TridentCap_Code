...
class BeamSearcherTwo0(DecodeStrategy):
    ...
    def _forward(self, batched_inputs, model):
        ...
        le_out = model.s_e(inputs, mode='embed')
        ...
        inputs = model.decoder_2.preprocess(inputs)
        ...
        for t in range(self.max_seq_len):
            ...
            decoder_out = model.decoder_2(inputs)
...
@DECODE_STRATEGY_REGISTRY.register()
class BeamSearcherTwo1(DecodeStrategy):
